...
<html lang="es">
    ...
    <body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 px-2">
                        <h2>Listado de grados académicos<h2>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-12 overflowX">
                        <table class="table" id="listado">
                            ...
                            <tbody class="expediente-cuerpo-tabla">
                                <?php
                                    $select = "SELECT * FROM ".TBL_GRADO_ACADEMICO;
        ...
        <div class="modal fade" id="acciones_departamento" tabindex="-1" role="dialog" aria-hidden="true">
            <form id="form_item" action="procedures/grado-academico.php" method="post">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <input type="hidden" id="id_grado_accion" name="id_grado" value="">
                </div>
            </form>
        </div>
        
        <div class="modal fade" id="AgregarDato" tabindex="-1" role="dialog" aria-hidden="true">
            <form id="form_departamento" action="procedures/grado-academico.php" method="post">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="texto_Modal_metodo">Nuevo grado académico</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    <input type="hidden" id="id_edit" name="id_grado" value="">
                </div>
            </form>
        </div>
        ...
        <script type="text/javascript">
            function establecer_agregar() {
                ...
                $("#id_edit")                .val("")
                $("#texto_Modal_metodo")     .html("Nuevo grado académico")
            }
            ...
            function establecer_editar(informacion) {
                ...
                $("#texto_Modal_metodo").html(`Modificar grado académico`)
            ...
            function eliminar(informacion) {
                ...
                $("#id_grado_accion").val(informacion.id)
