<?php
    ...
    **************************************************/
    ...
    function agregaDB($url_list, $Quick_function, $Data){
        ...
        /* Inicia los datos de la DB */
            $datos  = array(
                ...
                ':salario_base' => (isset($Data['salario_base']))  ? strip_tags(trim($Data["salario_base"])) : "",
                ':id_departamento' => (isset($Data['id_departamento']))  ? strip_tags(trim($Data["id_departamento"])) : "",
            );
        /* Inicia los datos de la DB */
    ...
    function editarDB($url_list, $Quick_function, $Data){
        /* Inicia los datos de la DB */
            $datos  = array(
                ':id'     => (isset($Data['id_puestos']))? strip_tags(trim($Data["id_puestos"])) : 0,
                ':nombre' => (isset($Data['nombre']))? strip_tags(trim($Data["nombre"])) : "",
                ':salario_base' => (isset($Data['salario_base']))  ? strip_tags(trim($Data["salario_base"])) : "",
                ':id_departamento' => (isset($Data['id_departamento']))  ? strip_tags(trim($Data["id_departamento"])) : "",
            );
    ...
    function borrarDB($url_list, $Quick_function, $Data){
        /* Inicia los datos de la DB */
            $datos  = array(':id' => (isset($Data['id_puestos'])) ? strip_tags(trim($Data["id_puestos"])) : 0,);
        /* Inicia los datos de la DB */
