...
<html lang="es">
    ...
    <body>
        ...
        <div class="modal fade" id="acciones_departamento" tabindex="-1" role="dialog" aria-hidden="true">
            <form id="form_item" action="procedures/cursos.php" method="post">
        ...
        <div class="modal fade" id="AgregarDato" tabindex="-1" role="dialog" aria-hidden="true">
            <form id="form_departamento" action="procedures/cursos.php" method="post">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <small class="form-text text-dark"><span class="asteriscos">* </span>Tiempo de capacitación</small>
                                    <input type="text" class="form-control" placeholder="Tiempo de capacitación" name="tiempo_capacitacion" id="tiempo_capacitacion">
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            function establecer_agregar() {
                ...
                $("#id_edit")                .val("")
                $("#texto_Modal_metodo")     .html("Nuevo curso")
            }
            ...
            function establecer_editar(informacion) {
                ...
                $("#texto_Modal_metodo").html(`Modificar curso`)
                $("#id_edit")           .val(informacion.id)

                $("#nombre").val(informacion.nombre)
                $("#tiempo_capacitacion").val(informacion.tiempo_capacitacion)
            }
