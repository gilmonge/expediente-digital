                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="row align-items-center">
                                <div class="col-lg-10">
                                    <h3 class="text-secondary mb-2" id="frase_dicho"></h3>
                                </div>
                    ...
                    <div class="row align-items-center justify-content-md-between pb-4">
                        <div class="col-md-6">
                            <div class="copyright text-sm font-weight-bold text-center text-md-left">
                                © 2022 <a href="https://rexystudios.com" class="font-weight-bold" target="_blank">Carnes Castillo</a>. Todos los derechos reservados.
                            </div>
                        </div>
                        <div class="col-md-6">
