                                            ...
                                            <form>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Usuario" value="Nombre Apellido" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                ...
                                                <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="Nombre" value="Nombre" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-last-name">Apellido</label>
                                                                <input type="text" id="input-last-name" class="form-control form-control-alternative" placeholder="Apellido" value="Apellido" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-sexo" class="form-control form-control-alternative" placeholder="" value="Masculino" enable>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-fecha_nacimiento" class="form-control form-control-alternative" placeholder="22-2-1990" value="22-2-1990" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-last-name">Identificación:</label>
                                                                <input type="text" id="input-cedula" class="form-control form-control-alternative" placeholder="11111111" value="11111111" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-licencia_conduccion" class="form-control form-control-alternative" placeholder="Si/No" value="Si" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-last-name">Tipo Licencia:</label>
                                                                <input type="text" id="input-tipo_licencia" class="form-control form-control-alternative" placeholder="" value="B1" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-telefono" class="form-control form-control-alternative" placeholder="" value="8888-8888" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-first-name">Correo electrónico:</label>
                                                                <input type="text" id="input-correo" class="form-control form-control-alternative" placeholder="" value="nombre@gmail.com" enable>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-estado_civil" class="form-control form-control-alternative" placeholder="" value="Soltero" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-first-name">Cantidad de hijos:</label>
                                                                <input type="text" id="input-hijos" class="form-control form-control-alternative" placeholder="" value="0" enable>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input enable id="input-residencia" class="form-control form-control-alternative" placeholder="Home Address" value="Bld Mihail Kogalniceanu, nr. 8 Bl 1, Sc 1, Ap 09" type="text">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input enable type="text" id="input-city" class="form-control form-control-alternative" placeholder="City" value="New York">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-country">Country</label>
                                                                <input enable type="text" id="input-country" class="form-control form-control-alternative" placeholder="Country" value="United States">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label class="form-control-label text-dark" for="input-country">Postal code</label>
                                                                <input enable type="number" id="input-postal-code" class="form-control form-control-alternative" placeholder="Postal code">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="pl-lg-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-fecha_contratacion" class="form-control form-control-alternative" placeholder="" value="01-01-2022" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-first-name">Salario:</label>
                                                                <input type="text" id="input-salario_actual" class="form-control form-control-alternative" placeholder="" value="$1000" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-id_puesto" class="form-control form-control-alternative" placeholder="" value="Carnicero" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-id_sucursal">Sucursal:</label>
                                                                <input type="text" id="input-id_sucursal" class="form-control form-control-alternative" placeholder="" value="San José" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-id_talla_uniforme" class="form-control form-control-alternative" placeholder="" value="M" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-banco" class="form-control form-control-alternative" placeholder="" value="BAC" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-cuenta_iban">Cuenta IBAN:</label>
                                                                <input type="text" id="input-cuenta_iban" class="form-control form-control-alternative" placeholder="" value="CR0017765437998" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-cuenta_cliente" class="form-control form-control-alternative" placeholder="" value="0972569982175" enable>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                <label class="form-control-label text-dark" for="input-numero_sinpe">Numero SINPE:</label>
                                                                <input type="text" id="input-numero_sinpe" class="form-control form-control-alternative" placeholder="" value="8888-8888" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group focused">
                                                                ...
                                                                <input type="text" id="input-id_grado_academico" class="form-control form-control-alternative" placeholder="" value="Técnico" enable>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!--div class="form-group focused text-dark">
                                                        ...
                                                        <textarea enable rows="4" class="form-control form-control-alternative" placeholder="A few words about you ...">A beautiful Dashboard for Bootstrap 4. It is Free and Open Source.</textarea>
                                                    </div-->
                                                </div>
                                            </form>
                                        </div>
